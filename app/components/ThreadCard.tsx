...
function ThreadCard({ question }: { question?: IQuestion & { _id?: string } }) {
  return (
    <div>
      <Link
        href={ROUTES.QUESTION_DETAILS((question as any)?._id?.toString() ?? "")}
      >
